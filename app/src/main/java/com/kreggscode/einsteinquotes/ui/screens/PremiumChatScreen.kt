...
import com.kreggscode.einsteinquotes.viewmodel.ChatMessage
...
fun PremiumChatScreen(
    ...
    Box(
        ...
        Column(
            ...
            // Premium Header
            PremiumChatHeader(onBackClick = onBackClick)
...
@Composable
fun PremiumChatHeader(onBackClick: () -> Unit) {
    GlassmorphicCard(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Row(
            ...
            // Einstein Avatar with animation
            Box(
                modifier = Modifier
                    .size(45.dp)
                    .clip(CircleShape)
                    .background(
                        brush = Brush.radialGradient(
                            colors = PremiumColors.GalaxyGradient
                        )
                    ),
...
fun WelcomeCard() {
    GlassmorphicCard(
        ...
        Column(
            ...
            Text(
                "Ask me about physics, philosophy, life, or the mysteries of the universe!",
...
fun SuggestionsCard(onSuggestionClick: (String) -> Unit) {
    val suggestions = listOf(
        ...
        "How did you discover E=mc²?",
        "What advice would you give to young scientists?",
        "Tell me about quantum mechanics",
        "What are your thoughts on imagination vs knowledge?"
    )
...
fun PremiumChatInput(
    ...
    GlassmorphicCard(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
            .padding(bottom = 80.dp), // Space for floating nav bar
        glowColor = PremiumColors.ElectricPurple,
        cornerRadius = 24.dp
    ) {
        Row(
