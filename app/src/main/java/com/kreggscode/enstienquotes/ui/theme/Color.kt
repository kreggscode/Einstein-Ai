...
// Einstein-inspired Light Mode Colors - Cosmic & Scientific
...
// Einstein-inspired Dark Mode Colors - Deep Space Theme
...
// Einstein Accent Colors - Scientific & Cosmic
val AccentGold = Color(0xFFFBBF24)  // Einstein's golden equations
...
val GlassDark = Color(0xE61A1F2E)  // Enhanced dark glass
val GlassBlur = Color(0x99FFFFFF)  // Subtle blur overlay
val GlassDarkBlur = Color(0x991A1F2E)  // Dark blur overlay
