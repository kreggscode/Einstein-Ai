                    ...
                    onShareClick = {
                        try {
                            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                type = "text/plain"
                                putExtra(Intent.EXTRA_SUBJECT, "Einstein - Insights & Wisdom")
                                putExtra(Intent.EXTRA_TEXT, "Check out Einstein - Insights & Wisdom app! Get inspired by Einstein's wisdom daily.\n\nhttps://play.google.com/store/apps/details?id=com.kreggscode.enstienquotes")
                            }
                ...
                RateAppSection(
                    onRateClick = {
                        try {
                            ...
                            val playStoreIntent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.kreggscode.enstienquotes"))
                            playStoreIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                            context.startActivity(playStoreIntent)
                        } catch (e: Exception) {
                            // If Play Store app is not available, open in browser
                            try {
                                val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kreggscode.enstienquotes"))
        ...
        Row(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        "Share Einstein wisdom with friends",
                        style = MaterialTheme.typography.bodySmall,
                        color = PremiumColors.CyberBlue
                    )
                }
            ...
            onClick = {
                try {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        ...
                        putExtra(Intent.EXTRA_SUBJECT, "Einstein App Feedback")
                    }
